...
const sfx: Dictionary = {
	...
	SFX.OPEN:							[audioOPEN,							PITCH_2,		0.0,			false],
	SFX.COIN:							[audioCOIN,							NOPITCH,		0.0,			false],
	SFX.GEM:							[audioGEM,							NOPITCH,		0.0,			false],
	SFX.LIFE:							[audioLIFE,							NOPITCH,		0.0,			false],
	SFX.MAXLIFE:					[audioMAXLIFE,					NOPITCH,		0.0,			false],
	SFX.PWEAPONREFILL:		[audioPWEAPONREFILL,		NOPITCH,		0,0,			false],
	SFX.SWEAPONREFILL:		[audioSWEAPONREFILL,		NOPITCH,		0.0,			false],
	SFX.SSHIELDREFILL:		[audioSSHIELDREFILL,		NOPITCH,		0.0,			false],
	SFX.LSHIELDREFILL:		[audioLSHIELDREFILL,		NOPITCH,		0.0,			false],
}
